...
console.log(singlyLinkedListObj.remove(0));
...
console.log(singlyLinkedListObj); // { head: { 0, { 1, { 2, null } } } }

console.log("==============================");

console.log(singlyLinkedListObj.remove(0)); // { head: { 1, { 2, null } } }
console.log(singlyLinkedListObj);

console.log(singlyLinkedListObj.remove(2)); // Big Index, No Item -index === length-. 

console.log(singlyLinkedListObj.remove(1)); // { head: { 1, null } }
console.log(singlyLinkedListObj);

console.log("==============================");

singlyLinkedListObj.push(22);
singlyLinkedListObj.push(333);
singlyLinkedListObj.push(4444);
console.log(singlyLinkedListObj);

console.log(singlyLinkedListObj.remove(2));
console.log(singlyLinkedListObj);

console.log(singlyLinkedListObj.remove(1));
console.log(singlyLinkedListObj);
